...
2. Buatlah  kode  program  PL/SQL  untuk  melakukan  statemen  select  employee  yang memiliki manager id = 300. Program harus dilengkapi dengan exception handling untuk menangani kondisi error:
